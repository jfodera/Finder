            ...
            <ul>
                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    ...
                    <?php if ($_SESSION['is_recorder']): ?>
                        <li><a href="<?php echo (basename($_SERVER['PHP_SELF']) == 'index.php') ? 'php/found_items.php' : 'found_items.php'; ?>">Add Found Item</a></li>
                    <?php else: ?>
                        <li><a href="<?php echo (basename($_SERVER['PHP_SELF']) == 'index.php') ? 'php/lost_items.php' : 'lost_items.php'; ?>">Report Lost Item</a></li>
                    <?php endif; ?>
