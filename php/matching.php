        ...
        try {
            ...
            foreach ($lostItems as $lostItem) {
                ...
                foreach ($foundItems as $foundItem) {
                    ...
                    if (!$checkStmt->fetch()) {
                        // Calculate traditional score as before
                        ...
                        // Check for Grok score
                        $grokScore = isset($_SESSION['grok_scores'][$lostItem['item_id']][$foundItem['item_id']]) 
                            ? $_SESSION['grok_scores'][$lostItem['item_id']][$foundItem['item_id']] 
                            : null;
                    
                        // Calculate final similarity score
                        $similarityScore = $grokScore !== null 
                            ? ($grokScore * 0.6 + $traditionalScore * 0.4)  // 60% Grok, 40% traditional
                            : $traditionalScore;  // Fallback to traditional if no Grok score
